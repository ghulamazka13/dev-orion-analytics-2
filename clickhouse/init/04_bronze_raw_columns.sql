...
ALTER TABLE bronze.zeek_events_raw
  ...
  ADD COLUMN IF NOT EXISTS ssl_cipher Nullable(String),
  ADD COLUMN IF NOT EXISTS ssl_curve Nullable(String),
  ADD COLUMN IF NOT EXISTS ssl_established Nullable(UInt8),
  ADD COLUMN IF NOT EXISTS ssl_cert_chain_fps Array(String) DEFAULT [],
